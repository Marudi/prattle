...
<div class="row">
    ...
    <tr>
        ...
        <td class="center"><?php echo $request->driver_id; ?></td>
        <td class="center"><?php echo $request->id; ?></td>
        <td class="center"><?php echo get_document($request->id); ?></td> 
        <td class="center"><?php echo $request->status; ?></td>
  

        
        <td class="center">
            <a class="btn btn-success btn-sm view-requestdoc" href="javascript:void(0);" data-id="<?php echo $request->id; ?>">
