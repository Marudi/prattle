...
public function updatedriver_status(){
 ...
 //        //print_r($response_a);
	...
	public function distance($origins,$destination){
		...
		$url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=$origins&destinations=$destination&mode=driving&key=AIzaSyB1br9lwKFyEpCnS5elLan_90CCsYeak6I";
